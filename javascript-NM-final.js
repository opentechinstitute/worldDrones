...
d3.csv("/sites/all/themes/bootstrap_subtheme/data/wod_export.csv", function(flights) {
  var linksByOrigin = {},
      countByAirport = {},
      locationByAirport = {},
      positions = [];
  ...
  d3.csv("/sites/all/themes/bootstrap_subtheme/data/wod.csv", function(airports) {
...
d3.csv("/sites/all/themes/bootstrap_subtheme/data/wod_import.csv", function(flights) {
  var linksByOrigin = {},
      countByAirport = {},
      locationByAirport = {},
      positions = [];
